...
urlpatterns = [
    ...
    path("repositories/<uuid:repo_id>/", views.repository_detail, name="repository_detail"),
    path("repositories/<uuid:repo_id>/edit/", views.repository_edit, name="repository_edit"),
    path("repositories/<uuid:repo_id>/delete/", views.repository_delete, name="repository_delete"),
    ...
    path("admin/repositories/", views.admin_repository_list, name="admin_repository_list"),
]